...
2.5.1 :001 > require './lib/menu.rb'
 => true
2.5.1 :002 > require './lib/takeaway.rb'
 => true
2.5.1 :003 > standard_menu = Menu.new(salad: 4.75, soup: 3.50, sandwich: 6.25)
 => #<Menu:0x00007f8dc61b4468 ..>
2.5.1 :004 > t = Takeaway.new(menu: standard_menu)
 => #<Takeaway:0x00007f8dc61a73d0 ..>
2.5.1 :005 > t.view_menu
 => {:salad=>4.75, :soup=>3.5, :sandwich=>6.25}
2.5.1 :006 > t.choose(:salad, 1)
 => {:salad=>1}
2.5.1 :007 > t.choose(:salad, 2)
 => {:salad=>3}
2.5.1 :008 > t.choose(:pizza, 1)
RuntimeError (Cannot add pizza: it is not on the menu)
2.5.1 :009 > t.choose(:soup, 0)
RuntimeError (Cannot add soup: invalid quantity chosen)
2.5.1 :010 > t.choose(:soup, 1)
 => {:salad=>3, :soup=>1}
2.5.1 :011 > t.view_total
 => 17.75
2.5.1 :012 > t.submit_order
 => "Order received!" 
```
